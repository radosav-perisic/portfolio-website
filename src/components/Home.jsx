    ...
    <div name="home" className="w-full h-screen background">
      ...
      />
          <Link to="work" smooth={true} duration={800}>
            <button className="text-[#ec8406ea] hover:text-white font-bold text-[1rem] md:text-[1.25rem] tracking-wide group border-[4px] px-3 py-[0.7rem] my-2 flex items-center hover:bg-[#ec8406ea] hover:border-[#ec8406ea] duration-500 bg-[#202020]">
              View Work
