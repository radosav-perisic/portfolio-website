    ...
    <div name="skills" className="bg-[#262626] w-full h-screen text-[#bcbcb3]">
      ...
      <div className="max-w-[1000px] md:p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-4 text-center py-8">
          <div className="shadow-md lg:py-5 sm:py-2 mx-4 my-4 shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-24 mx-auto" src={Javascript} alt="HTML icon" />
            <p className='pt-4 text-xl'>Javascript</p>
          </div>
          <div className="shadow-md lg:py-5 sm:py-2 mx-4 my-4 shadow-[#040c16] hover:scale-110 duration-500">
          ...
          <div className="shadow-md lg:py-5 sm:py-2 mx-4 my-4 shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <p className='pt-4 text-xl'>HTML</p>
          </div>
          <div className="shadow-md lg:py-5 sm:py-2 mx-4 my-4 shadow-[#040c16] hover:scale-110 duration-500">
