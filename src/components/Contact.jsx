...
const  Contact = () => {
  ...
  return (
    ...
    <form method='POST' action='https://getform.io/f/458cfa83-c534-4402-b446-978e8a78cd76' className='flex flex-col max-w-[600px] w-full'>
         <div className='z-prop pb-5'>
            <p className='text-4xl font-bold inline  border-b-4 border-[#ca8a04] text-[#bcbcb3]'>Contact</p>
            <p className='text-[#bcbcb3] pt-4 pb-1 overflow-hidden white-space: nowrap'>// Submit the form below or send me an email - radosavperisic.contact@gmail.com</p>
         </div>
         <ResumeButton />
         <input  type='text' name='name' placeholder='Name'className='z-prop bg-[#ccd6f6] mt-4 p-2'/>
